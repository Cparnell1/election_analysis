...
# file_to_load1 = os.path.join(C:\Users\coope\Desktop\election_analysis\Resources\election_results.csv)
file_to_load1 = r"C:\Users\coope\Desktop\election_analysis\Resources\election_results.csv"
print(file_to_load1)
# Add a variable to save the file to a path.
file_to_save = os.path.join("Analysis", "election_analysis.txt")
file_to_save1 = os.path.join("Desktop","election_analysis","Analysis", "election_analysis.txt")
